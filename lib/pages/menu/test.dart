...
class MyHomePage123 extends StatefulWidget {
  @override
  _MyHomePageState123 createState() => _MyHomePageState123();
}

class _MyHomePageState123 extends State<MyHomePage123> {
  static final Completer<GoogleMapController> _controller = Completer();

  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(-6.2295601, 106.9973988),
    zoom: 18.4746,
  );
  ...
  _onPanUpdate(DragUpdateDetails details) async {
    ...
    if (_drawPolygonEnabled) {
      ...
      try {
        ...
        //   print("_userPolyLinesLatLngList" + _userPolyLinesLatLngList.toString());
  ...
  _clearPolygons() {
    setState(() {
      _polyLines.clear();
      _polygons.clear();
      debugPrint(_userPolyLinesLatLngList.toString(), wrapWidth: 1024);
